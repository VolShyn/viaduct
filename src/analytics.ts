...
const DEFAULT_WEBSITE_ID = '6eb196a0-1c83-4c7d-aaf5-2a63390e0ba3';
...
function readConfig(): UmamiConfig {
  ...
  const websiteId =
    (import.meta.env.VITE_UMAMI_WEBSITE_ID || '').trim() || DEFAULT_WEBSITE_ID;
...
/** Load Umami Cloud script once. Safe to call repeatedly. */
export function initAnalytics(): void {
  ...
  // SPA: we send pageviews ourselves on every route change.
