...
describe('jsonIO', () => {
  ...
  describe('exportModel', () => {
    ...
    it('should export only current container view when scope is current', () => {
      mockStore.model = {
        systems: [
          { id: 'sys1', name: 'S1', connections: [], type: 'system', position: { x: 0, y: 0 } },
          { id: 'sys2', name: 'S2', connections: [], type: 'system', position: { x: 0, y: 0 } },
        ],
        containers: [
          { id: 'c1', name: 'C1', systemId: 'sys1', connections: [], type: 'container', position: { x: 0, y: 0 } },
          { id: 'c2', name: 'C2', systemId: 'sys2', connections: [], type: 'container', position: { x: 0, y: 0 } },
        ],
        components: [
          { id: 'p1', name: 'P1', systemId: 'sys1', containerId: 'c1', connections: [], type: 'component', position: { x: 0, y: 0 } },
        ],
        codeElements: [],
        viewLevel: 'container',
        activeSystemId: 'sys1',
      ...
      const parsed = JSON.parse(exportModel('current'));
      expect(parsed.systems).toHaveLength(1);
      expect(parsed.systems[0].id).toBe('sys1');
      expect(parsed.containers).toHaveLength(1);
      expect(parsed.containers[0].id).toBe('c1');
